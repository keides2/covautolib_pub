...
class COVApi:
    ...
    def __init__(self, group=None, project=None, branch=None, commit=None):
        ...
        # 認証キー
        # self.API_AUTH = ("shimatani", "08EEDxxxxxxx2B6")
    ...
    def cov_get_issues_columns(self):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/issues/columns?locale=ja_JP&queryType=bySnapshot&retrieveGroupByColumns=false" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_projects(self, project):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/projects/st-idu?includeChildren=true&includeStreams=true&locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_all_projects(self):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/projects?includeChildren=false&includeStreams=false&locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_all_streams(self):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/streams?=excludeRoles=true&locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_all_snapshots_in_stream(self, stream):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/streams/stream/snapshots?idType=byName&name=My_Stream&locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_views(self):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/views?locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_views_user(self):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/views/user?locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
    ...
    def cov_get_view_contents(self, file_path, view_id, project_id):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/views/viewContents/10551?projectId=10072&rowCount=10&offset=0&sortKey=cid&sortOrder=desc&locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
        print(
    ...
    def cov_post_issues_search(
        ...
        """ curl
      # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
      # --request POST "https://sast.kbit-repo.net/api/v2/issues/search? \
      ...
      """
        ...
        """ session 利用（不要）
      # ログインURLの設定
      url_login = "https://sast.kbit-repo.net/login/login.htm"
    ...
    def cov_post_issueOccurrences_search(
        ...
        """ curl
      # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
      # --request POST "https://sast.kbit-repo.net/api/v2/issueOccurrences/search? \
      # includeColumnLabels=true& \
      # locale=ja_JP& \
      # offset=0& \
      # queryType=bySnapshot& \
    ...
    def convert_list_row_df(self, json_file, encoding):
        ...
        """転置前
                                 key                                              value
        0                        cid                                             430811
        1                displayFile  /cov/groups/d-net/st-idu/d4-net-vrv{}idu_devel...
        2               fileLanguage                                                  C
        ...
        value  430811  /cov/groups/d-net/st-idu/d4-net-vrv{}idu_devel...             C  ...  db67f17a460d15fdff078efcf1a31150  EvSche_InitModule        
        """
    ...
    def convert_dic_df_from_dict(self, json_file, encoding):
        ...
        "rows": [
            [
                ...
                {
                    "key": "displayFile",
                    "value": "/cov/groups/d-net/st-idu/d4-net-vrv{}idu_develop/Drv/Hal/EvSche/src/EvSche.c"
                },
                ... snip ...
                {
                    "key": "fileLanguage",
        ...
        0, '430811', '/cov/groups/d-net/st-idu/.../EvSche.c', ... snip ... , ''}"
    ...
    def right_outer_join(self, df_left, df_right, file_dir, encoding):
        ...
        # 'C:\\cov\\groups\\wlan-adapter\\daikin_smart_edge\\cov_issues\\right_outer_join.csv'
        df.to_csv(file_path, header=True, index=False, encoding=encoding)
    ...
    def user_id_exists_in_file(self, file_path, user_id):
        ...
        "nabeshima","雅貴","鍋島","masataka.nabeshima@daikin.co.jp","false","ユーザー;","2020-07-17T06:40:20.134Z"
        "shimatani","圭介","嶋谷","keisuke.shimatani@daikin.co.jp","false","ユーザー;アドミニストレータ;","2021-11-01T06:17:34.737Z"
         :
        """
    ...
    def get_user_id_by_email(self, file_path, email):
        ...
        使用例:
        file_path = 'path/to/your/csvfile.csv'  # CSVファイルのパス
        email = 'keisuke.shimatani@daikin.co.jp'  # 検索したい電子メールアドレス
    ...
    def user_id_exists(self, user_id):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request GET "https://sast.kbit-repo.net/api/v2/users/shimataniu?locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
            ...
            "users": [
                {
                  ...
                  "disabled": false,
                  "domainName": null,
                  "email": "keisuke.shimatani@daikin.co.jp",
                  "familyName": "嶋谷",
                  "given_name": "圭介",
                  "groupNames": [
                    "Administrators",
            ...
            "users": [
                {
                  ...
                  "disabled": false,
                  "domainName": null,
                  "email": "masahiro1.kaneko@daikin.co.jp",
                  "familyName": "金子",
                  "givenName": "雅裕",
                  "groupNames": [
                    "Users"
    ...
    def cov_get_all_users(self):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" ^
        # --request GET "https://sast.kbit-repo.net/api/v2/users?disabled=false&includeDetails=true&locked=false&offset=0&rowCount=200&sortColumn=name&sortOrder=asc" ^
        # --header "Accept: application/json" ^
        # --header "Content-Type: application/json" ^
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
        ...
        },
        {
          ...
          "disabled": false,
          "domainName": null,
          "email": "kazuaki.andou@daikin.co.jp",
          "familyName": "安藤",
          "givenName": "和陽",
          "groupNames": [
            "Users"
        ...
        try:
            ...
            file_path = "S:\\空調生産本部ITソリューション開発Ｇ\\開発g\\脆弱性情報\\coverity\\authorized_user\\authorized_user.json"
    ...
    def send_account_issuance_email(self, user_id, user_email, generated_password):
        ...
        """
        # SMTPサーバーの設定
        smtp_server = "smtp.daikin.co.jp"
        smtp_port = 25
        # smtp_user = "keisuke.shimatani@daikin.co.jp"
        # smtp_password = "your_password"

        # user_id = "tester"
        # user_email = "keisuke.shimatani@daikin.co.jp"
        # generated_password = "12345"

        # メールの設定
        from_email = "CovLicense <keisuke.shimatani@daikin.co.jp>"
        to_email = user_email
        cc_emails = [
            "keisuke.shimatani@daikin.co.jp",
            "ryouji.inoue@daikin.co.jp",
            "shouichi.hasuike@daikin.co.jp",
            "katsuji.oi@daikin.co.jp",
            "masahiro1.kaneko@daikin.co.jp",
        ]
        ...
        Coverity Connect サーバー https://sast.kbit-repo.net/ にログインし、
        仮パスワードを変更してください。
    ...
    def create_new_user(self, user_info):
        ...
        """
        # curl --location -x "http://bypsproxy.daikin.co.jp:3128/" \
        # --request POST "https://sast.kbit-repo.net/api/v2/users?locale=ja_JP" \
        # --header "Accept: application/json" \
        # --header "Content-Type: application/json" \
        # --user shimatani:08EED5855B845CDA35C5FD289DAA32B6
        # -d {...}
